...
public class SensitiveDataDeserializer extends JsonDeserializer<String> {
  ...
  private static final Map<MaskType, Function<String, String>> MASK_STRATEGIES =
      Map.of(
          MaskType.FULL, value -> MASKED_VALUE,
          MaskType.PARTIAL,
              value -> partialMask(value, 4) // Default prefix length, overridden by annotation
          );
  ...
  public String deserialize(JsonParser parser, DeserializationContext context) throws IOException {
    ...
    Function<String, String> maskStrategy =
        MASK_STRATEGIES.getOrDefault(annotation.maskType(), v -> v);
