        ...
        setDeserializerModifier(new BeanDeserializerModifier() {
            ...
            public com.fasterxml.jackson.databind.deser.BeanDeserializerBuilder updateBuilder(
                ...
                builder.getProperties().forEachRemaining(property -> {
                    ...
                    if (property.getMember() != null && property.getMember().hasAnnotation(SensitiveData.class)) {
                        SensitiveData annotation = property.getMember().getAnnotation(SensitiveData.class);
                        // Apply deserializer only for String fields
                        if (property.getType().getRawClass() == String.class) {
                            builder.addOrReplaceProperty(
                                    property.withValueDeserializer(new SensitiveDataDeserializer(annotation)),
                                    true);
                        }
                    }
                });
